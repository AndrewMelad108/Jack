  ...
  <div class="SpareParts min-h-[100vh] my-10">
    ...
    <div class="Towing-content grid lg:grid-cols-2 grid-cols-1 gap-6 mt-2">
      ...
      <div class="lists">
        ...
        <InputAdd @AddOptions="AddSparePartsTypeOption" />
        <ServicesTables
          :options="SparePartsType"
          @editOption="editOption($event)"
        />
      </div>
      <div class="lists">
        ...
        <InputAdd @AddOptions="addBrandOptions" />
...
export default {
  ...
  methods: {
    ...
    addSearchScopeOption(newoptions) {
      ...
      sendRequest(
        `Admin/FilterValue?ServiceID=3&FilterID=5&Value=${newoptions}`,
        "post",
        null,
        true,
        successCallback,
    ...
    AddSparePartsTypeOption(newoptions) {
      let successCallback = (res) => {
        if (res.data.success) {
          this.getAllServicesOptions();
        }
      ...
      sendRequest(
        `Admin/FilterValue?ServiceID=3&FilterID=6&Value=${newoptions}`,
        "post",
        {
          Value: newoptions,
        },
    ...
    addBrandOptions(newoptions) {
      ...
      sendRequest(
        `Admin/FilterValue?ServiceID=3&FilterID=2&Value=${newoptions}`,
        "post",
        {
          Value: newoptions,
        },
    ...
    addModelOption(newoptions) {
      ...
      sendRequest(
        `Admin/FilterValue?ServiceID=3&FilterID=3&Value=${newoptions}`,
        "post",
        {
          Value: newoptions,
        },
    ...
    addManufacturOption(newoptions) {
      ...
      sendRequest(
        `Admin/FilterValue?ServiceID=3&FilterID=4&Value=${newoptions}`,
        "post",
        {
          Value: newoptions,
        },
