<template>
  <section class="AllServices px-12 py-4">
    ...
    <div class="capitalize flex justify-between mb-6 md:text-lg text-sm mt-10">
    ...
    <div
      ...
      class="mt-4 max-w-[700px] lg:flex hidden w-auto h-[300px] mx-auto overflow-x-scroll md:gap-10"
    >
      <div
